...
def connect_menu(main_window, profile_controller, network_thread):
    ...
    mw2_action = game_menu.addAction("海")
    ...
    halo_5_action = game_menu.addAction("地上")
    ...
    halo_infinite_action = game_menu.addAction("畑の収穫")
    ...
    vanguard_action = game_menu.addAction("森林")
    ...
    trap_tower_action = game_menu.addAction("トラップタワー")
    ...
    auto_switch_game_action = top_menu.addAction("&バイオーム自動切り替え")
